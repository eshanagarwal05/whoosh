...
extension-zip: check
	...
	cd extension && zip -9 -r ../dist/$(UUID).zip extension.js extension-main.js extension-core.js touchscreen.js fourfinger.js mouse.js prefs.js metadata.json schemas
